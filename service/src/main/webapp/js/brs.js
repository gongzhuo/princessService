...
$.getJSON("./conf/dataconfig.json", function (jsonData){
    url = jsonData.url +":"+ jsonData.port + "/rest/school/v1/student";
    console.log("URL = " + url);
});
...
function loadNeData() {
    var requestUrl =url + "/rest/school/v1/student/batchQuery";
    $
        .ajax({
            type: "GET",
            url: requestUrl,
...
$(function () {
    ...
    $('#createNe').click(function () {
        ...
        console.log("create student data=" + formData);
        var jsonobj = JSON.parse(formData);
        var requestUrl = url;
        $
            .ajax({
